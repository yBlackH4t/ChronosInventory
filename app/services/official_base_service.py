...
from app.services.official_base_status_service import OfficialBaseStatusService
...
class OfficialBaseService:
    ...
    def __init__(self) -> None:
        ...
        self.status_service = OfficialBaseStatusService(
            db_connection=self.db_connection,
            config_store=self.config_store,
            publication_helper=self.publication_helper,
            local_share_service=self.local_share_service,
            latest_dirname=self._latest_dirname,
            history_dirname=self._history_dirname,
    ...
    def test_directory_access(self) -> Dict[str, Any]:
        return self.status_service.test_directory_access()

    def list_history(self, limit: int = 10) -> List[Dict[str, Any]]:
        return self.status_service.list_history(limit=limit)
    ...
    def test_remote_server(self, server_url: Optional[str] = None) -> Dict[str, Any]:
        return self.status_service.test_remote_server(server_url)
    ...
    def list_server_history(self, limit: int = 10) -> List[Dict[str, Any]]:
        return self.status_service.list_server_history(limit=limit)
